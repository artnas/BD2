...
CREATE TABLE IF NOT EXISTS `mydb`.`ParkingLot` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Street_Address1_idx` (`address_id` ASC) VISIBLE,
  INDEX `fk_ParkingLot_Zone1_idx` (`zone_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Camera` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Camera_ParkingLot1_idx` (`parking_lot_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Fine` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Fine_Controller1_idx` (`controller_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`EParkingTicket` (
  ...
  INDEX `fk_occupation_car1_idx` (`vehicle_id` ASC) VISIBLE,
  INDEX `fk_VirtualOccupation_ParkingLot1_idx` (`parking_lot_id` ASC) VISIBLE,
  INDEX `fk_EParkingTicket_Bill1_idx` (`Bill_id` ASC) VISIBLE,
  INDEX `fk_EParkingTicket_Fine1_idx` (`Fine_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`ParkingMeter` (
  ...
  `parking_lot_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ParkingMeter_ParkingLot1_idx` (`parking_lot_id` ASC) VISIBLE,
